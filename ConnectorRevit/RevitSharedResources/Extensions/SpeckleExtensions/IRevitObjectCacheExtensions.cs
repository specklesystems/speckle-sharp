...
namespace RevitSharedResources.Extensions.SpeckleExtensions
{
  ...
  {
    public static List<ElementType> GetOrAddGroupOfTypes(this IRevitObjectCache<List<ElementType>> cache, IRevitCategoryInfo categoryInfo)
    {
      var elementTypes = cache
        .GetOrAdd(
