...
namespace Objects.Structural.GSA.Geometry
{
    public class GSARigidConstraint : Base
    {
        ...
        public GSARigidConstraint(string name, int nativeId, Node primaryNode, List<Node> constrainedNodes, Base parentMember, List<GSAStage> stages, LinkageType type, Dictionary<AxisDirection6, List<AxisDirection6>> constraintCondition)
        {
            this.name = name;
