...
namespace Speckle.Core.Api
{
  public static partial class Operations
  {
    ...
    public static async Task<string> Upload(Base @object, ITransport localTransport = null, IEnumerable<Remote> remotes = null, Action<ConcurrentDictionary<string, int>> onProgressAction = null)
    {
    ...
    public static async Task<List<string>> Upload(IEnumerable<Base> objects, SqlLiteObjectTransport localTransport = null, IEnumerable<Remote> remotes = null, Action<ConcurrentDictionary<string, int>> onProgressAction = null)
    {
      var (serializer, settings) = GetSerializerInstance();
      localTransport = localTransport != null ? localTransport : new SqlLiteObjectTransport();
