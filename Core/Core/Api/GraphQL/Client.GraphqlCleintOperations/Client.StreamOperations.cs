...
namespace Speckle.Core.Api
{
  public partial class Client
  {
    ...
    public Task<Stream> StreamGet(string id, int branchesLimit = 10) =>
      StreamGet(CancellationToken.None, id, branchesLimit);
    ...
    )
    {
      ...
      return (await ExecuteGraphQLRequest<StreamData>(request, cancellationToken)).stream;
    }
    ...
    public Task<List<Stream>> StreamsGet(int limit = 10) =>
      StreamsGet(CancellationToken.None, limit);
    ...
    public Task<List<Stream>> FavoriteStreamsGet(int limit = 10) =>
      FavoriteStreamsGet(CancellationToken.None, limit);
    ...
    )
    {
      ...
      return (await ExecuteGraphQLRequest<ActiveUserData>(request, cancellationToken))
        .activeUser
        .favoriteStreams
        .items;
    }
    ...
    public Task<List<Stream>> StreamSearch(string query, int limit = 10) =>
      StreamSearch(CancellationToken.None, query, limit);
    ...
    )
    {
      ...
      return (await ExecuteGraphQLRequest<StreamsData>(request, cancellationToken)).streams.items;
    }
    ...
    public Task<string> StreamCreate(StreamCreateInput streamInput) =>
      StreamCreate(CancellationToken.None, streamInput);
    ...
    public Task<bool> StreamUpdate(StreamUpdateInput streamInput) =>
      StreamUpdate(CancellationToken.None, streamInput);
    ...
    /// <returns></returns>
    public Task<bool> StreamDelete(string id) => StreamDelete(CancellationToken.None, id);
    ...
    public Task<bool> StreamGrantPermission(StreamPermissionInput permissionInput) =>
      StreamGrantPermission(CancellationToken.None, permissionInput);
    ...
    public Task<bool> StreamRevokePermission(StreamRevokePermissionInput permissionInput) =>
      StreamRevokePermission(CancellationToken.None, permissionInput);
    ...
    public Task<Stream> StreamGetPendingCollaborators(string id) =>
      StreamGetPendingCollaborators(CancellationToken.None, id);
    ...
    public Task<bool> StreamInviteCreate(StreamInviteCreateInput streamCreateInput) =>
      StreamInviteCreate(CancellationToken.None, streamCreateInput);
