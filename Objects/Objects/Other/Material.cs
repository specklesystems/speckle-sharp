...
namespace Objects.Other.Revit
{
  ...
  public class RevitMaterial : Material
  {
    ...
    [DetachProperty]
    public RevitAppearanceAssetElement AppearanceAssetElement { get; set; }
 ...
 RevitAppearanceAssetElement AppearanceAssetElement, List<Parameter> parameters = null)
    {
      ...
      this.AppearanceAssetElement = AppearanceAssetElement;
    }
  }

  public class RevitAppearanceAssetElement : Base
  {
    public string AssestName { get; set; }
    public RenderingAssest RenderingAssest { get; set; }

  }

  public class RenderingAssest : Base
  {

    public string Name { get; set; }
    public List<RenderingAssetProperty> AssestProperties { get; set; } = new List<RenderingAssetProperty>();


  }

  public class RenderingAssetProperty : Base
  {
    public string Name { get; set; }
    public string Type { get; set; }
    public string Value { get; set; }
    public List<RenderingAssetProperty> ConnectedProperties { get; set; } = new List<RenderingAssetProperty>();
