...
namespace Objects.Other
{
  ...
  /// </remarks>
  public class Transform_old : Base
  {
    ...
    public Transform_old(double[] value, string units = null)
    {
      this.value = value;
      this.units = units;
    }
    ...
    public Transform_old(double[] x, double[] y, double[] z, double[] translation, string units = null)
    {
      this.units = units;
      value = new[]
      {
    ...
    /// <returns></returns>
    public static Transform_old operator *(Transform_old t1, Transform_old t2)
    {
      ...
      return new Transform_old(result);
    }
  }
