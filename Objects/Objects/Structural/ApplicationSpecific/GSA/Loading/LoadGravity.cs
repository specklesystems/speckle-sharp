...
{
    public class LoadGravity : Structural.Loading.LoadGravity
    {
        ...
        public LoadGravity(int nativeId, string name, Structural.Loading.LoadCase loadCase, Vector gravityFactors = null)
        {
        ...
        public LoadGravity(int nativeId, string name, Structural.Loading.LoadCase loadCase, List<Base> elements, Vector gravityFactors = null)
        {
            this.nativeId = nativeId;
            this.name = name;
        ...
        public LoadGravity(int nativeId, string name, Structural.Loading.LoadCase loadCase, List<Base> elements, List<Base> nodes, Vector gravityFactors = null, string nativedId = null)
        {
            this.nativeId = nativeId;
            this.name = name;
            this.elements = elements;
