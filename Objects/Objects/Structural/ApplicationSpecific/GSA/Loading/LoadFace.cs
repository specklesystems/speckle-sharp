...
{
    public class LoadFace : Structural.Loading.LoadFace
    {
        public int nativeId { get; set; }
        public LoadFace() { }

        [SchemaInfo("GSALoadFace", "Creates a Speckle structural face (2D elem/member) load for GSA", "GSA", "Loading")]
        public LoadFace(int nativeId, Structural.Loading.LoadCase loadCase, List<Base> elements, FaceLoadType loadType, LoadDirection2D direction, LoadAxisType loadAxisType = LoadAxisType.Global,
