...
namespace Objects.Structural.GSA.Bridge
{
    public class GSAUserVehicle : Base
    {
        ...
        public GSAUserVehicle(int nativeId, string name, double width, List<double> axlePositions, List<double> axleOffsets, List<double> axleLeft, List<double> axleRight)
        {
