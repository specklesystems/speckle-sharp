...
namespace Objects.Structural.CSI.Geometry
{
  public class CSINode : Node
  {
    ...
    [SchemaInfo("Node with properties", "Creates a Speckle CSI node with spring, mass and/or damper properties", "CSI", "Geometry")]
    public CSINode(Point basePoint,
    string name = null,
    ...
    CSISpringProperty springProperty = null, PropertyMass massProperty = null, PropertyDamper damperProperty = null, CSIDiaphragm CSIDiaphragm = null, DiaphragmOption DiaphragmOption = DiaphragmOption.FromShellObject)
    {
      ...
      this.CSISpringProperty = springProperty;
      this.massProperty = massProperty;
      this.damperProperty = damperProperty;
      this.DiaphragmAssignment = CSIDiaphragm.name;
