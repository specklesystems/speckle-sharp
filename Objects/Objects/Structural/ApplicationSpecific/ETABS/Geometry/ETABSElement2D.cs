...
namespace Objects.Structural.ETABS.Geometry
{
  public class ETABSElement2D : Element2D
  {
    ...
    public ETABSElement2D(List<Node> nodes, Property2D property, double offset = 0, double orientationAngle = 0, ETABSAreaSpring ETABSAreaSpring = null,ETABSDiaphragm ETABSDiaphragm = null)
    {
      this.topology = nodes;
