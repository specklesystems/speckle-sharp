...
namespace Objects.Structural.Results
{
    ...
    public class Result2D : Result //result at a single position within a 2D element, ie. 2D element contains multiple Result2D objects to describe result at node 1, node 2, node 3, node4 and centre of 4-node quad element
    {
        ...
        public Result2D(Element2D element, LoadCombination resultCase, List<double> position, float dispX, float dispY, float dispZ, float forceXX, float forceYY, float forceXY, float momentXX, float momentYY, float momentXY, float shearX, float shearY, float stressTopXX, float stressTopYY, float stressTopZZ, float stressTopXY, float stressTopYZ, float stressTopZX, float stressMidXX, float stressMidYY, float stressMidZZ, float stressMidXY, float stressMidYZ, float stressMidZX, float stressBotXX, float stressBotYY, float stressBotZZ, float stressBotXY, float stressBotYZ, float stressBotZX)
        {
            this.element = element;
            this.resultCase = resultCase;
            this.position = position;
