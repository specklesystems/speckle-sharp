...
namespace Objects.BuiltElements.Revit
{
  public class RevitLevel : Level
  {
    ...
    /// <remarks>Assign units when using this constructor due to <paramref name="elevation"/> param</remarks>
    [SchemaInfo("Create level", "Creates a new Revit level unless one with the same elevation already exists", "BIM", "Architecture")]
    public RevitLevel(
    ...
    [SchemaInfo("Level by name", "Gets an existing Revit level by name", "BIM", "Architecture")]
