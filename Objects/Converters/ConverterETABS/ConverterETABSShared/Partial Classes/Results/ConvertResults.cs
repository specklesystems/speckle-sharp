...
namespace Objects.Converter.ETABS
{
    public partial class ConverterETABS
    {
        public ResultSetAll ResultsToSpeckle()
        {
            ...
            ResultSetAll results = new ResultSetAll(AllResultSet1dToSpeckle(convertedFrameNames, convertedPierNames, convertedSpandrelNames), new ResultSet2D(), new ResultSet3D(), ResultGlobal(), AllResultSetNodesToSpeckle());
