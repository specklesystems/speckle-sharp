...
namespace Objects.Converter.ETABS
{
    public partial class ConverterETABS
    {
        public ResultGlobal ResultGlobal()
        {
            ...
            Model.Results.ModalPeriod(ref numberResult, ref loadcase, ref stepType, ref stepNum, ref period, ref frequency, ref circFreq, ref eigenValue);
            ...
            Model.Results.ModalParticipationFactors(ref numberResult, ref loadcase, ref stepType, ref stepNum, ref period, ref UX, ref UY, ref UZ, ref RX, ref RY, ref RZ, ref ModalMass, ref ModalStiff);
