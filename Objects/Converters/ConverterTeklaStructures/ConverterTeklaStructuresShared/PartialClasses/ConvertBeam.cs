    ...
    if (beam is TeklaBeam)
    {
      ...
      switch (teklaBeam.TeklaBeamType)
      {
        ...
        case TeklaBeamType.SpiralBeam:
          ...
          var startPt = new TSG.Point(
            teklaSpiralBeam.startPoint.x,
            teklaSpiralBeam.startPoint.y,
            teklaSpiralBeam.startPoint.z
          );
          var rotatAxisPt1 = new TSG.Point(
            teklaSpiralBeam.rotationAxisPt1.x,
            teklaSpiralBeam.rotationAxisPt1.y,
            teklaSpiralBeam.rotationAxisPt1.z
          );
          var rotatAxisPt2 = new TSG.Point(
            teklaSpiralBeam.rotationAxisPt2.x,
            teklaSpiralBeam.rotationAxisPt2.y,
            teklaSpiralBeam.rotationAxisPt2.z
          );
          ...
          var spiralBeam = new Tekla.Structures.Model.SpiralBeam(
            startPt,
            rotatAxisPt1,
            rotatAxisPt2,
            totalRise,
  ...
  public TeklaBeam BeamToSpeckle(Tekla.Structures.Model.Beam beam)
  {
    ...
    if (rebars != null)
    {
      foreach (var rebar in rebars)
      {
        ...
        {
          speckleBeam.rebars = RebarGroupToSpeckle((RebarGroup)rebar);
        }
      }
    }
