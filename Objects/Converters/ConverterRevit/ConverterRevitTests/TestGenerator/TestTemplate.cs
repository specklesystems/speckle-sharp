...
";
    //    public static string Create(string category, string fileName, string revitType, string syncAssertFunc) => $@"
    ...
    //    {{
    //      await SpeckleToNative<{revitType}>({syncAssertFunc});
    //    }}
    ...
    //    {{
    //      await SpeckleToNativeUpdates<{revitType}>({syncAssertFunc});
    //    }}
    ...
    //    {{
    //      await SelectionToNative<{revitType}>({syncAssertFunc});
    //    }}
    //  }}
    //";
