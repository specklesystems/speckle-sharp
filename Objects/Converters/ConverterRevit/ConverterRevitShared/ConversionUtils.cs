    ...
    private ElementFilter GetCategoryFilter(Base element)
    {
      switch (element)
      {
        case BuiltElements.Wall _:
          return new ElementMulticategoryFilter(SHC.wallCategories);
        case Column _:
          return new ElementMulticategoryFilter(SHC.columnCategories);
        case Beam _:
        case Brace _:
          return new ElementMulticategoryFilter(SHC.beamCategories);
        case Duct _:
          return new ElementMulticategoryFilter(SHC.ductCategories);
        ...
        case Floor _:
          return new ElementMulticategoryFilter(SHC.floorCategories);
        case Pipe _:
          return new ElementMulticategoryFilter(SHC.pipeCategories);
        case Roof _:
