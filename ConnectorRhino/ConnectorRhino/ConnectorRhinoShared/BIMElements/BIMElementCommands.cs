...
public class SpeckleBIM
{
  ...
  private static string SpeckleSchemaKey = "SpeckleSchema";
  private static string DirectShapeKey = "DirectShape";
  ...
  public class CreateWall : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Wall.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateFloor : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Floor.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateColumn : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Column.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateBeam : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Beam.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreatePipe : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Pipe.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateDuct : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Duct.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateFaceWall : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.FaceWall.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateTopography : Command
  {
    ...
    {
      var selectedObjects = GetObjectSelection(
        new List<ObjectType> { ObjectType.Mesh, ObjectType.Brep, ObjectType.SubD }
      );
      if (selectedObjects == null)
        return Result.Cancel;
      ApplySchema(selectedObjects, SchemaObjectFilter.SupportedSchema.Topography.ToString(), doc);
      return Result.Success;
    }
  }
  ...
  public class CreateAdaptiveComponent : Command
  {
    ...
    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      ...
      List<RhinoObject> selectedObjects = new();
      for (; ; )
      {
        ...
        if (res == GetResult.Object)
        {
          ...
          var basePoint = geometry.First() as Point; // Use first selected point as basepoint
          ...
          var transform = Transform.Translation(basePoint.Location - doc.ModelBasepoint);
  ...
  public class ApplySpeckleSchema : Command
  {
    ...
    public static ApplySpeckleSchema Instance { get; private set; }

    public override string EnglishName => "Apply" + SpeckleSchemaKey;
  ...
  public class RemoveSpeckleSchema : Command
  {
    ...
    public static RemoveSpeckleSchema Instance { get; private set; }

    public override string EnglishName => "Remove" + SpeckleSchemaKey;

    protected override Result RunCommand(RhinoDoc doc, RunMode mode)
    {
      GetObject getObjs = new();
  ...
  protected static void ApplySchema(
  ...
  )
  {
    ...
    if (asDirectShape)
    {
      foreach (RhinoObject obj in objs)
        if (
          obj.ObjectType == ObjectType.Brep
