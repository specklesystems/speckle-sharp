...
Name: microstation; Description: Speckle for MicroStation CONNECT Edition - v{#MicroStationVersion};  Types: full
Name: openroads; Description: Speckle for OpenRoads Designer CONNECT Edition - v{#OpenRoadsVersion};  Types: full
Name: openrail; Description: Speckle for OpenRail Designer CONNECT Edition - v{#OpenRailVersion};  Types: full
Name: openbuildings; Description: Speckle for OpenBuildingsDesigner CONNECT Edition - v{#OpenBuildingsVersion};  Types: full
