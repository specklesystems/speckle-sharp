...
[Components]
Name: microstation; Description: Speckle for MicroStation CONNECT Edition ALPHA - v{#MicroStationVersion};  Types: full
Name: openroads; Description: Speckle for OpenRoads Designer CONNECT Edition ALPHA - v{#OpenRoadsVersion};  Types: full
Name: openrail; Description: Speckle for OpenRail Designer CONNECT Edition ALPHA - v{#OpenRailVersion};  Types: full
Name: openbuildings; Description: Speckle for OpenBuildingsDesigner CONNECT Edition ALPHA - v{#OpenBuildingsVersion};  Types: full
