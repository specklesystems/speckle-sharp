...
public abstract class RhinoObjectToSpeckleConverter<TTopLevelIn, TInRaw, TOutRaw> : IHostObjectToSpeckleConversion
  ...
  where TOutRaw : Base
{
  ...
  protected RhinoObjectToSpeckleConverter(IRawConversion<TInRaw, TOutRaw> conversion)
  {
