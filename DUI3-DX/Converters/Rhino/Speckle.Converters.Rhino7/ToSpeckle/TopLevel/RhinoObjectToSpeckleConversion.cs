...
public abstract class RhinoObjectToSpeckleConversion<TTopLevelIn, TInRaw, TOutRaw>
  : IHostObjectToSpeckleConversion<CommonObject>
  ...
  where TOutRaw : Base
{
  ...
  public virtual Base Convert(CommonObject target)
  {
