...
public class CurveToHostDBCurveConverter : ISpeckleObjectToHostConversion, IRawConversion<SOG.Curve, ADB.Curve>
{
  private readonly IRawConversion<SOG.Curve, AG.NurbCurve3d> _curveConverter;
  public CurveToHostDBCurveConverter(IRawConversion<SOG.Curve, AG.NurbCurve3d> curveConverter)
  {
