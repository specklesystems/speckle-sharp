...
public class MultipatchFeatureToSpeckleConverter : IRawConversion<Multipatch, IReadOnlyList<GisPolygonGeometry>>
{
  private readonly IRawConversion<ReadOnlySegmentCollection, SOG.Polyline> _segmentConverter;

  public MultipatchFeatureToSpeckleConverter(IRawConversion<ReadOnlySegmentCollection, SOG.Polyline> segmentConverter)
  {
    _segmentConverter = segmentConverter;
  }

  public IReadOnlyList<GisPolygonGeometry> RawConvert(Multipatch target)
  {
