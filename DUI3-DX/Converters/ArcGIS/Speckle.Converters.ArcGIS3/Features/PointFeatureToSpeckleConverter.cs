...
public class PointFeatureToSpeckleConverter : IHostObjectToSpeckleConversion, IRawConversion<MapPoint, GisFeature>
{
  ...
  public GisFeature RawConvert(MapPoint target)
  {
    if (
    ...
    return new GisFeature { geometry = geometry };
  }
}
