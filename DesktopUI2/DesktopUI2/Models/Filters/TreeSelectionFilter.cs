...
namespace DesktopUI2.Models.Filters
{
  public class TreeSelectionFilter : ISelectionFilter
  {
    ...
    public ObservableCollection<TreeNode> SelectedItems { get; set; } = new ObservableCollection<TreeNode>();
    Type ISelectionFilter.ViewType { get; } = typeof(TreeFilterView);

    public TreeSelectionFilter() => SelectedItems.CollectionChanged += Items_CollectionChanged;
  ...
  public class TreeNode : DynamicObject
  {
    ...
    [JsonProperty("Elements")] public List<TreeNode> Elements { get; set; } = new List<TreeNode>();
