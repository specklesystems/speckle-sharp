...
public class BraceSchemaComponent: CreateSchemaObjectBase {
    ...
    public BraceSchemaComponent(): base("Brace", "Brace", "Creates a Speckle brace", "Speckle 2 BIM", "Architecture") { }
...
public class RevitBraceSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitBraceSchemaComponent(): base("RevitBrace", "RevitBrace", "Creates a Revit brace by curve and base level.", "Speckle 2 Revit", "Architecture") { }
...
public class RevitColumnSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitColumnSchemaComponent(): base("Vertical Column", "Vertical Column", "Creates a vertical Revit Column by point and levels.", "Speckle 2 Revit", "Structure") { }
...
public class RevitFaceWallSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitFaceWallSchemaComponent(): base("Wall by face", "Wall by face", "Creates a Revit wall from a surface.", "Speckle 2 Revit", "Architecture") { }
...
public class RevitLevelSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitLevelSchemaComponent(): base("Create level", "Create level", "Creates a new Revit level unless one with the same elevation already exists", "Speckle 2 BIM", "Architecture") { }
...
public class RevitShaftSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitShaftSchemaComponent(): base("RevitShaft", "RevitShaft", "Creates a Revit shaft from a bottom and top level", "Speckle 2 Revit", "MEP") { }
...
public class RevitWallSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitWallSchemaComponent(): base("Wall by curve and levels", "Wall by curve and levels", "Creates a Revit wall with a top and base level.", "Speckle 2 Revit", "Architecture") { }
...
public class RevitWireSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitWireSchemaComponent(): base("RevitWire", "RevitWire", "Creates a Revit wire from points and level", "Speckle 2 Revit", "Curves") { }
...
public class WireSchemaComponent: CreateSchemaObjectBase {
    ...
    public WireSchemaComponent(): base("Wire", "Wire", "Creates a Speckle wire from curve segments and points", "Speckle 2 BIM", "Other") { }
