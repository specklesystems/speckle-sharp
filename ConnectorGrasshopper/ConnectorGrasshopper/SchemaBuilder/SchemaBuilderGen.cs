...
public class AdaptiveComponentSchemaComponent: CreateSchemaObjectBase {
    ...
    public AdaptiveComponentSchemaComponent(): base("AdaptiveComponent", "AdaptiveComponent", "AdaptiveComponent", "Speckle 2 Revit", "Families") { }
...
public class AreaSchemaComponent: CreateSchemaObjectBase {
    ...
    public AreaSchemaComponent(): base("Area", "Area", "Area", "Speckle 2 BIM", "Other") { }
...
public class BeamSchemaComponent: CreateSchemaObjectBase {
    ...
    public BeamSchemaComponent(): base("Beam", "Beam", "Beam", "Speckle 2 BIM", "Structure") { }
...
public class BraceSchemaComponent: CreateSchemaObjectBase {
    ...
    public BraceSchemaComponent(): base("Brace", "Brace", "Brace", "Speckle 2 BIM", "Architecture") { }
...
public class CeilingSchemaComponent: CreateSchemaObjectBase {
    ...
    public CeilingSchemaComponent(): base("Ceiling", "Ceiling", "Ceiling", "Speckle 2 BIM", "Architecture") { }
...
public class ColumnSchemaComponent: CreateSchemaObjectBase {
    ...
    public ColumnSchemaComponent(): base("Column", "Column", "Column", "Speckle 2 BIM", "Structure") { }
...
public class DetailCurveSchemaComponent: CreateSchemaObjectBase {
    ...
    public DetailCurveSchemaComponent(): base("DetailCurve", "DetailCurve", "DetailCurve", "Speckle 2 Revit", "Curves") { }
...
public class DirectShapeSchemaComponent: CreateSchemaObjectBase {
    ...
    public DirectShapeSchemaComponent(): base("DirectShape", "DirectShape", "DirectShape", "Speckle 2 Revit", "Families") { }
...
public class DuctSchemaComponent: CreateSchemaObjectBase {
    ...
    public DuctSchemaComponent(): base("Duct", "Duct", "Duct", "Speckle 2 BIM", "MEP") { }
...
public class FamilyInstanceSchemaComponent: CreateSchemaObjectBase {
    ...
    public FamilyInstanceSchemaComponent(): base("FamilyInstance", "FamilyInstance", "FamilyInstance", "Speckle 2 Revit", "Families") { }
...
public class FloorSchemaComponent: CreateSchemaObjectBase {
    ...
    public FloorSchemaComponent(): base("Floor", "Floor", "Floor", "Speckle 2 BIM", "Architecture") { }
...
public class FreeformElementSchemaComponent: CreateSchemaObjectBase {
    ...
    public FreeformElementSchemaComponent(): base("FreeformElement", "FreeformElement", "FreeformElement", "Speckle 2 Revit", "Families") { }
...
public class GridLineSchemaComponent: CreateSchemaObjectBase {
    ...
    public GridLineSchemaComponent(): base("GridLine", "GridLine", "GridLine", "Speckle 2 BIM", "Other") { }
...
public class LevelSchemaComponent: CreateSchemaObjectBase {
    ...
    public LevelSchemaComponent(): base("Level", "Level", "Level", "Speckle 2 BIM", "Architecture") { }
...
public class ModelCurveSchemaComponent: CreateSchemaObjectBase {
    ...
    public ModelCurveSchemaComponent(): base("ModelCurve", "ModelCurve", "ModelCurve", "Speckle 2 Revit", "Curves") { }
...
public class ParameterSchemaComponent: CreateSchemaObjectBase {
    ...
    public ParameterSchemaComponent(): base("Parameter", "Parameter", "Parameter", "Speckle 2 Revit", "Families") { }
...
public class ParameterUpdaterSchemaComponent: CreateSchemaObjectBase {
    ...
    public ParameterUpdaterSchemaComponent(): base("ParameterUpdater", "ParameterUpdater", "ParameterUpdater", "Speckle 2 Revit", "Families") { }
...
public class PipeSchemaComponent: CreateSchemaObjectBase {
    ...
    public PipeSchemaComponent(): base("Pipe", "Pipe", "Pipe", "Speckle 2 BIM", "MEP") { }
...
public class RenderMaterialSchemaComponent: CreateSchemaObjectBase {
    ...
    public RenderMaterialSchemaComponent(): base("RenderMaterial", "RenderMaterial", "RenderMaterial", "Speckle 2 BIM", "Other") { }
...
public class RevitBeamSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitBeamSchemaComponent(): base("RevitBeam", "RevitBeam", "RevitBeam", "Speckle 2 Revit", "Structure") { }
...
public class RevitBraceSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitBraceSchemaComponent(): base("RevitBrace", "RevitBrace", "RevitBrace", "Speckle 2 Revit", "Architecture") { }
...
public class RevitColumnSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitColumnSchemaComponent(): base("RevitColumn", "RevitColumn", "RevitColumn", "Speckle 2 Revit", "Structure") { }
...
public class RevitDuctSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitDuctSchemaComponent(): base("RevitDuct", "RevitDuct", "RevitDuct", "Speckle 2 Revit", "MEP") { }
...
public class RevitExtrusionRoofSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitExtrusionRoofSchemaComponent(): base("RevitExtrusionRoof", "RevitExtrusionRoof", "RevitExtrusionRoof", "Speckle 2 Revit", "Architecture") { }
...
public class RevitFaceWallSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitFaceWallSchemaComponent(): base("RevitFaceWall", "RevitFaceWall", "RevitFaceWall", "Speckle 2 Revit", "Architecture") { }
...
public class RevitFloorSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitFloorSchemaComponent(): base("RevitFloor", "RevitFloor", "RevitFloor", "Speckle 2 Revit", "Architecture") { }
...
public class RevitFootprintRoofSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitFootprintRoofSchemaComponent(): base("RevitFootprintRoof", "RevitFootprintRoof", "RevitFootprintRoof", "Speckle 2 Revit", "Architecture") { }
...
public class RevitLevelSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitLevelSchemaComponent(): base("RevitLevel", "RevitLevel", "RevitLevel", "Speckle 2 BIM", "Architecture") { }
...
public class RevitPipeSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitPipeSchemaComponent(): base("RevitPipe", "RevitPipe", "RevitPipe", "Speckle 2 Revit", "MEP") { }
...
public class RevitRailingSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitRailingSchemaComponent(): base("RevitRailing", "RevitRailing", "RevitRailing", "Speckle 2 Revit", "Architecture") { }
...
public class RevitShaftSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitShaftSchemaComponent(): base("RevitShaft", "RevitShaft", "RevitShaft", "Speckle 2 Revit", "MEP") { }
...
public class RevitTopographySchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitTopographySchemaComponent(): base("RevitTopography", "RevitTopography", "RevitTopography", "Speckle 2 Revit", "Architecture") { }
...
public class RevitWallSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitWallSchemaComponent(): base("RevitWall", "RevitWall", "RevitWall", "Speckle 2 Revit", "Architecture") { }
...
public class RevitWireSchemaComponent: CreateSchemaObjectBase {
    ...
    public RevitWireSchemaComponent(): base("RevitWire", "RevitWire", "RevitWire", "Speckle 2 Revit", "Curves") { }
...
public class RoofSchemaComponent: CreateSchemaObjectBase {
    ...
    public RoofSchemaComponent(): base("Roof", "Roof", "Roof", "Speckle 2 BIM", "Architecture") { }
...
public class RoomSchemaComponent: CreateSchemaObjectBase {
    ...
    public RoomSchemaComponent(): base("Room", "Room", "Room", "Speckle 2 BIM", "Architecture") { }
...
public class RoomBoundaryLineSchemaComponent: CreateSchemaObjectBase {
    ...
    public RoomBoundaryLineSchemaComponent(): base("RoomBoundaryLine", "RoomBoundaryLine", "RoomBoundaryLine", "Speckle 2 Revit", "Curves") { }
...
public class TopographySchemaComponent: CreateSchemaObjectBase {
    ...
    public TopographySchemaComponent(): base("Topography", "Topography", "Topography", "Speckle 2 BIM", "Architecture") { }
...
public class WallSchemaComponent: CreateSchemaObjectBase {
    ...
    public WallSchemaComponent(): base("Wall", "Wall", "Wall", "Speckle 2 BIM", "Architecture") { }
...
public class WireSchemaComponent: CreateSchemaObjectBase {
    ...
    public WireSchemaComponent(): base("Wire", "Wire", "Wire", "Speckle 2 BIM", "Other") { }
