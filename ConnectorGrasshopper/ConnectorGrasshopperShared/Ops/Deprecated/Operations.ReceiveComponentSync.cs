...
public class ReceiveSync : SelectKitTaskCapableComponentBase<Base>
{
  ...
  /// </summary>
  public override Guid ComponentGuid => new("a1e073a0-5203-438b-9310-e212fc81675d");
  ...
  {
    var streamInputIndex = pManager.AddGenericParameter(
      "Stream",
      "S",
  ...
  public override void SolveInstanceWithLogContext(IGH_DataAccess DA)
  {
    ...
    else
    {
      ...
      Converter?.SetContextDocument(Loader.GetCurrentDocument());
      var data = Utilities.ConvertToTree(Converter, @base, AddRuntimeMessage);
