...
public class ExtendSpeckleObjectTaskComponent : SelectKitTaskCapableComponentBase<Base>, IGH_VariableParameterComponent
{
  private DebounceDispatcher nicknameChangeDebounce = new();

  public ExtendSpeckleObjectTaskComponent()
    : base(
  ...
  protected override Bitmap Icon => Resources.ExtendSpeckleObject;
  public override GH_Exposure Exposure => GH_Exposure.secondary;
  public override Guid ComponentGuid => new("2D455B11-F372-47E5-98BE-515EA758A669");
  ...
  protected override void RegisterOutputParams(GH_OutputParamManager pManager)
  {
    pManager.AddParameter(
      new SpeckleBaseParam("Extended Speckle Object", "EO", "Extended speckle object.", GH_ParamAccess.item)
    );
  }
