...
public class MemoryTransportComponent : GH_SpeckleComponent
{
  ...
  public MemoryTransportComponent()
    : base(
      "Memory Transport",
      "Memory",
  ...
  internal static Guid internalGuid => new("B3E7A1E0-FB96-45AE-9F47-54D1B495AAC9");
  ...
  protected override Bitmap Icon => Resources.MemoryTransport;
